...
const CreateForm: React.FC<IProps> = ({blog, setBlog}) => {
  ...
  return (
    <form>
      ...
      <div className="form-group position-relative">
        <textarea className="form-control" rows={4} value={blog.description} style={{resize: 'none'}}
      ...
      <div className="form-group my-3">
        <select className="form-control text-capitalize" value={blog.category} name='category'
        onChange={handleChangeInput}>
